...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    profissionalizaAppAuthUserSubject.add(
      ProfissionalizaAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ProfissionalizaAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ProfissionalizaAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ProfissionalizaAppAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    profissionalizaAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
ProfissionalizaAppAuthUser? currentUser;
